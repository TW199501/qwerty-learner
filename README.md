...
Qwerty Learner 现在支持多语言界面，让全球用户都能轻松使用：

- 🇺🇸 英语 (English)
- 🇹🇼 繁体中文 (Traditional Chinese)
- 🇨🇳 简体中文 (Simplified Chinese)

语言会根据您的浏览器设置自动检测，您也可以在页面右上角手动切换语言。

### 贡献新的语言翻译

我们欢迎社区贡献更多的语言翻译！如果您想添加新的语言支持，请参考 [贡献指南](docs/CONTRIBUTING.md) 和 [多语言支持文档](docs/i18n-support.md)。
...
软件设计的目标群体为以英语作为主要工作语言的键盘工作者。部分人会出现输入母语时的打字速度快于英语的情况，因为多年的母语输入练就了非常坚固的肌肉记忆 💪，而英语输入的肌肉记忆相对较弱，易出现输入英语时“提筆忘字”的现象。

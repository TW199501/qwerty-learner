      ...
      <ScrollArea.Viewport className="h-full w-full px-3">
        <div className={styles.tabContent}>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>{t('dataManagement.export')}</span>
            ...
            <span className="pl-4 text-left text-sm font-bold leading-tight text-red-500">{t('dataManagement.exportWarning')}</span>
            ...
            <button
              ...
              title={t('dataManagement.exportButton')}
            >
              {t('dataManagement.exportButton')}
            </button>
          </div>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>{t('dataManagement.import')}</span>
            <span className={styles.sectionDescription}>
              请注意，导入数据将<strong className="text-sm font-bold text-red-500"> {t('dataManagement.importWarning')} </strong>
              当前数据。请谨慎操作。
            </span>
            ...
            <button
              ...
              title={t('dataManagement.importButton')}
            >

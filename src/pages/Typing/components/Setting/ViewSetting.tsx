      ...
      <ScrollArea.Viewport className="h-full w-full px-3">
        <div className={styles.tabContent}>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>{t('settings.fontSettings')}</span>
            <div className={styles.block}>
              <span className={styles.blockLabel}>{t('settings.foreignFont')}</span>
            ...
            <div className={styles.block}>
              <span className={styles.blockLabel}>{t('settings.chineseFont')}</span>
              <div className="flex h-5 w-full items-center justify-between">
                <Slider.Root
